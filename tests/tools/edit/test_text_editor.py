...
class TestTextEditorView:
    ...
    def test_view_simple_file(self, tmp_path):
    ...
    def test_view_range_to_eof(self, tmp_path):
    ...
    def test_view_directory_not_file(self, tmp_path):
        """Test viewing a directory instead of file."""
        editor = TextEditor()
        with pytest.raises(ValueError, match="Path is not a file"):
            editor.view(tmp_path)

    def test_view_range_invalid_format(self, tmp_path):
    ...
    def test_view_range_start_line_out_of_bounds(self, tmp_path):
    ...
    def test_view_range_end_line_out_of_bounds(self, tmp_path):
    ...
    def test_view_empty_file(self, tmp_path):
...
class TestTextEditorStrReplace:
    ...
    def test_str_replace_single_occurrence(self, tmp_path):
    ...
    def test_str_replace_multiple_occurrences(self, tmp_path):
    ...
    def test_str_replace_with_none(self, tmp_path):
    ...
    def test_str_replace_multiline(self, tmp_path):
    ...
    def test_str_replace_string_not_found(self, tmp_path):
    ...
    def test_str_replace_nonexistent_file(self, tmp_path):
    ...
    def test_str_replace_directory_not_file(self, tmp_path):
...
class TestTextEditorInsert:
    ...
    def test_insert_multiline_text(self, tmp_path):
    ...
    def test_insert_negative_line_number(self, tmp_path):
    ...
    def test_insert_line_number_too_large(self, tmp_path):
    ...
    def test_insert_in_empty_file(self, tmp_path):
    ...
    def test_insert_directory_not_file(self, tmp_path):
...
class TestTextEditorPathTraversal:
    ...
    def test_absolute_path_outside_project_currently_works(self, tmp_path):
        """
    ...
    def test_parent_directory_traversal_currently_works(self, tmp_path):
        """
    ...
    def test_write_outside_project_currently_works(self, tmp_path):
        """
...
class TestTextEditorErrorHandling:
    ...
    def test_write_file_to_readonly_parent(self, tmp_path):
    ...
    def test_view_file_with_unicode(self, tmp_path):
    ...
    def test_replace_in_binary_file(self, tmp_path):
...
class TestTextEditorEdgeCases:
    ...
    def test_view_file_with_no_newline_at_end(self, tmp_path):
    ...
    def test_view_very_long_lines(self, tmp_path):
    ...
    def test_str_replace_with_special_characters(self, tmp_path):
    ...
    def test_insert_with_windows_line_endings(self, tmp_path):
    ...
    def test_content_with_line_numbers_offset(self, tmp_path):
